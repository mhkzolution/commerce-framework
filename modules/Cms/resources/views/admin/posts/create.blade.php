...
@section('page')
    <x-admin.form.shell action="{{ route('admin.cms.posts.store') }}" method="POST" class="max-w-2xl">
        ...
        <x-admin.form.section title="Post details">
            ...
            <textarea name="excerpt" class="cf-input mt-1" rows="2">{{ old('excerpt') }}</textarea>
            ...
            <input name="published_at" type="datetime-local" value="{{ old('published_at') }}" class="cf-input mt-1">
