...
Route::middleware('web')->group(function (): void {
    ...
    Route::middleware(['auth', 'permission:cms.page.view'])
        ...
        ->group(function (): void {
            ...
            Route::middleware('permission:cms.category.view')->group(function (): void {
                Route::get('/categories', [CategoryController::class, 'index'])->name('categories.index');
            });

            Route::middleware('permission:cms.category.manage')->group(function (): void {
            ...
            Route::middleware('permission:cms.tag.view')->group(function (): void {
                Route::get('/tags', [TagController::class, 'index'])->name('tags.index');
            });

            Route::middleware('permission:cms.tag.manage')->group(function (): void {
