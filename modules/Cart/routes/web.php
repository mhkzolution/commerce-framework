...
Route::middleware('web')->group(function (): void {
    ...
    Route::get('/brands', [ShopController::class, 'brands'])->name('storefront.brands.index');
    Route::get('/brands/{slug}', [ShopController::class, 'showBrand'])->name('storefront.brands.show');
    ...
    Route::post('/cart/items', [StorefrontCartController::class, 'store'])
        ->middleware('storefront.purchase')
    ...
    Route::get('/checkout', [StorefrontCartController::class, 'checkoutForm'])
        ->middleware('storefront.purchase')
        ->name('storefront.checkout');
    Route::post('/checkout', [StorefrontCartController::class, 'checkout'])
        ->middleware('storefront.purchase')
