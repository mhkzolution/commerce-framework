...
use Commerce\Contracts\Catalog\CollectionQueryServiceInterface;
use Commerce\Core\Base\BaseQueryService;
use Illuminate\Contracts\Pagination\LengthAwarePaginator;

final class CollectionQueryService extends BaseQueryService implements CollectionQueryServiceInterface
{
