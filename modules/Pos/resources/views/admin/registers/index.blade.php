...
@section('page')
    <x-admin.page title="Register" description="Manage registers.">
        <x-slot:primaryActions>
            <x-admin.button variant="primary" :href="route('admin.pos.registers.create')">New</x-admin.button>
        </x-slot:primaryActions>
        <x-admin.table.shell>
            ...
            @forelse ($items as $item)
                <tr>
                    ...
                    <td class="px-4 py-3 text-right"><x-admin.button variant="link" :href="route('admin.pos.registers.edit', $item)">Edit</x-admin.button></td>
                </tr>
            @empty
