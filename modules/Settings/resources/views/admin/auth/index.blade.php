            ...
            <x-admin.card :title="__('settings::admin.auth_registration')">
                <label class="flex items-start gap-3">
                    <input
                        ...
                        value="1"
                        class="mt-1"
                        @checked(old('registration_enabled', $registrationEnabled))
                    >
                    <span>
                ...
                <div class="space-y-6">
                    <label class="flex items-start gap-3">
                        <input
                            ...
                            value="1"
                            class="mt-1"
                            @checked(old('recaptcha_enabled', $recaptchaEnabled))
                        >
                        <span>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('recaptcha_min_score', $recaptchaMinScore) }}"
                            min="0"
                            max="1"
                            step="0.1"
                            class="cf-input mt-1 max-w-xs"
                        >
                ...
                <div class="space-y-6">
                    <label class="flex items-start gap-3">
                        <input
                            ...
                            value="1"
                            class="mt-1"
                            @checked(old('line_enabled', $lineEnabled))
                        >
                        <span>
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('line_channel_id', $lineChannelId) }}"
                                class="cf-input mt-1"
                                autocomplete="off"
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('line_channel_secret', $lineChannelSecret) }}"
                                class="cf-input mt-1"
                                autocomplete="new-password"
                            >
                            <p class="mt-1 text-sm text-muted">{{ __('settings::admin.auth_secret_keep_hint') }}</p>
