    ...
    'navigation' => [
        ...
        [
            ...
            'children' => [
                ...
                ['type' => 'link', 'label' => 'Marketplace', 'route' => 'admin.marketplace.sellers.index', 'permission' => 'marketplace.seller.view', 'module' => 'marketplace'],
            ],
        ],
        [
            'type' => 'group',
        ...
        [
            ...
            'default_open' => true,
            'children' => [
                ['type' => 'link', 'label' => 'Posts', 'route' => 'admin.cms.posts.index', 'permission' => 'cms.post.view', 'module' => 'blog'],
        ...
        [
            ...
            'order' => 70,
            'children' => [
                ['type' => 'link', 'label' => 'Users', 'route' => 'admin.iam.users.index', 'permission' => 'iam.user.view', 'module' => 'users'],
        ...
        [
            ...
            'children' => [
                ...
                ['type' => 'link', 'label' => 'System Settings', 'route' => 'admin.settings.index', 'permission' => 'settings.setting.view', 'module' => 'settings'],
            ],
        ],
        [
            'type' => 'group',
