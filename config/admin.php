            ...
            'children' => [
                [
                    ...
                    'children' => [
                        ...
                        ['type' => 'link', 'label' => 'Pages', 'route' => 'admin.cms.pages.index', 'permission' => 'cms.page.view', 'module' => 'cms', 'aliases' => ['About Us', 'About', '404', 'Policies']],
                ...
                [
                    ...
                    'children' => [
                        ['type' => 'link', 'label' => 'Files', 'route' => 'admin.media.index', 'permission' => 'media.media.view', 'module' => 'media', 'aliases' => ['Gallery']],
                        [
                            'type' => 'group',
                            'id' => 'blog-articles',
                            'label' => 'Blog & articles',
                            'children' => [
                                ...
                                ['type' => 'link', 'label' => 'Blog', 'route' => 'admin.cms.posts.index', 'permission' => 'cms.post.view', 'module' => 'blog', 'aliases' => ['Articles', 'Blog']],
                ...
                [
                    ...
                    'label' => 'Shop display',
                    'children' => [
                        ['type' => 'link', 'label' => 'Checkout & Experience', 'route' => 'admin.settings.customer-experience.show', 'permission' => 'settings.setting.view', 'module' => 'customer-experience', 'aliases' => ['Shop', 'Product Detail', 'Cart', 'Checkout', 'Thank You']],
                        ['type' => 'link', 'label' => 'Store access', 'label_key' => 'admin::nav.labels.store_access', 'route' => 'admin.settings.store-visibility.show', 'permission' => 'settings.setting.view', 'module' => 'settings', 'aliases' => ['Visibility', 'Members Only', 'Catalog', 'Private']],
                    ],
                ],
                [
                    'type' => 'group',
                    ...
                    'label' => 'Appearance',
                    'children' => [
                        ['type' => 'link', 'label' => 'Theme', 'route' => 'admin.settings.appearance.show', 'permission' => 'settings.setting.view', 'module' => 'settings', 'aliases' => ['Storefront', 'Colors', 'Fonts', 'Layout']],
                    ],
                ],
                [
                    'type' => 'group',
                    ...
                    'label' => 'SEO & Marketing',
                    'children' => [
                        ['type' => 'link', 'label' => 'SEO', 'label_key' => 'admin::nav.labels.seo', 'route' => 'admin.settings.website.show', 'permission' => 'settings.setting.view', 'module' => 'settings', 'aliases' => ['Social Share', 'Pixel', 'Analytics', 'Banner Tracking']],
                    ],
                ],
            ],
        ],
