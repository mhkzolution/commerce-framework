...
<div {{ $attributes->merge(['class' => 'storefront-header-actions']) }}>
    <div class="storefront-header-actions__cluster storefront-header-actions__cluster--desktop">
        <button
            type="button"
    ...
    <div class="storefront-header-actions__cluster storefront-header-actions__cluster--mobile">
        <x-storefront.navigation.header-account class="storefront-header-account--inline" />
